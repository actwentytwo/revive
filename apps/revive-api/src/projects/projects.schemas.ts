import { z } from 'zod'
import { environmentSchema, environmentValidationSchema } from '../configurations/configurations.schemas.js'
...
export type AssignProjectConfigurationsInput = z.infer<typeof assignProjectConfigurationsInputSchema>
